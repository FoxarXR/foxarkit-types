...
// Generated: 2026-07-22T12:17:47Z
...
export type FoxarExports = {
  ...
  foxarkit_get_visualization_mode(): number
  ...
  view_action_triggered_with_value(actionIdPtr: number, valuePtr: number): number
  ...
  view_set_region(regionPtr: number): number
  execute_ready_callback(callbackId: number): number
  view_take_pending_guide_navigation(): number
